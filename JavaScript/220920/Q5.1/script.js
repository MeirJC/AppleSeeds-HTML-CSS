...
countryToLiveIn("Swahili", false, 47, "Uganda"); // Language not fit
countryToLiveIn("English", true, 0.017, "Cook Islands"); // Island
countryToLiveIn("English", false, 338, "United States"); // population too big
countryToLiveIn("English", false, 37, "Canada"); // will work
